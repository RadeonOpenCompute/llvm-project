...
; CHECK-NEXT:    tail call void @llvm.dbg.value(metadata i64 [[A]], metadata [[META9:![0-9]+]], metadata !DIExpression(DIOpArg(0, i64), DIOpReinterpret(ptr))), !dbg [[DBG12:![0-9]+]]
...
; CHECK-NEXT:    tail call void @llvm.dbg.value(metadata ptr [[A]], metadata [[META15:![0-9]+]], metadata !DIExpression(DIOpArg(0, ptr), DIOpReinterpret(i64))), !dbg [[DBG17:![0-9]+]]
...
; CHECK-NEXT:    tail call void @llvm.dbg.value(metadata i32 [[A]], metadata [[META20:![0-9]+]], metadata !DIExpression(DIOpArg(0, i32), DIOpZExt(i64))), !dbg [[DBG23:![0-9]+]]
...
; CHECK-NEXT:    tail call void @llvm.dbg.value(metadata i64 [[A]], metadata [[META26:![0-9]+]], metadata !DIExpression(DIOpArg(0, i64), DIOpConvert(i32))), !dbg [[DBG28:![0-9]+]]
...
; CHECK-NEXT:    tail call void @llvm.dbg.value(metadata i32 [[A]], metadata [[META31:![0-9]+]], metadata !DIExpression(DIOpArg(0, i32), DIOpSExt(i64))), !dbg [[DBG33:![0-9]+]]
; CHECK-NEXT:    call void @use_i32(i32 [[A]])
; CHECK-NEXT:    ret void
;
  %1 = sext i32 %A to i64
