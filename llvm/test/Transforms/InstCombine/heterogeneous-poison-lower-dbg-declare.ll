...
; CHECK-NEXT:    tail call void @llvm.dbg.value(metadata i32 42, metadata [[META11:![0-9]+]], metadata !DIExpression(DIOpArg(0, i32))), !dbg [[DBG12:![0-9]+]]
; CHECK-NEXT:    store i32 42, ptr [[VAR]], align 4
; CHECK-NEXT:    tail call void @llvm.dbg.value(metadata ptr [[VAR]], metadata [[META11]], metadata !DIExpression(DIOpArg(0, ptr), DIOpDeref(i32))), !dbg [[DBG12]]
; CHECK-NEXT:    call void @escape(ptr nonnull [[VAR]])
; CHECK-NEXT:    [[TMP0:%.*]] = load i32, ptr [[VAR]], align 4
; CHECK-NEXT:    tail call void @llvm.dbg.value(metadata i32 [[TMP0]], metadata [[META11]], metadata !DIExpression(DIOpArg(0, i32))), !dbg [[DBG12]]
...
; CHECK: [[DBG12]] = !DILocation(line: 0, scope: [[DBG5]])
;.
