...
entry:
  ...
  ; CHECK: call void @llvm.dbg.declare(metadata ptr %i, metadata ![[#]], metadata !DIExpression(DIOpArg(0, ptr), DIOpArg(0, ptr), DIOpComposite(2, %struct.type)))
  ...
  ; CHECK: call void @llvm.dbg.declare(metadata i16 42, metadata ![[#]], metadata !DIExpression(DIOpArg(0, i16), DIOpFragment(16, 16)))
