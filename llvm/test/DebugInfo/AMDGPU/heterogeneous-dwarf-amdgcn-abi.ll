...
; RUN: llc -O0 -mtriple=amdgcn-amd-amdhsa -mcpu=gfx906 -verify-machineinstrs -filetype=obj -emit-heterogeneous-dwarf-as-user-ops=true < %s | llvm-dwarfdump -debug-info - | FileCheck --check-prefixes=CHECK,CHECK-USER-OPS %s
