...
entry:
  ...
  ; CHECK: tail call void @llvm.dbg.value(metadata !DIArgList(ptr %var), metadata ![[#]], metadata !DIExpression(DIOpArg(0, ptr), DIOpFragment(1, 2), DIOpDeref(i32)))
  ...
  ; CHECK: tail call void @llvm.dbg.value(metadata ptr %var, metadata ![[#VAR:]], metadata !DIExpression(DIOpArg(0, ptr), DIOpDeref(i32)))
  ...
  ; CHECK: tail call void @llvm.dbg.value(metadata ptr %var_fragmented.lo, metadata ![[#VAR_FRAGMENTED:]], metadata !DIExpression(DIOpArg(0, ptr), DIOpDeref(i16), DIOpFragment(0, 16)))
  ...
  call void @ex()
  ; CHECK: tail call void @llvm.dbg.value(metadata ptr %var_fragmented.hi, metadata ![[#VAR_FRAGMENTED]], metadata !DIExpression(DIOpArg(0, ptr), DIOpDeref(i16), DIOpFragment(16, 16)))
