...
!CHECK:            %[[DERIVED_TYPE_ADDR:.*]] = fir.address_of(@_QFtest3Eres) : !fir.ref<!fir.type<_QMtypesTt3{r:!fir.box<!fir.ptr<!fir.array<?xf32>>>}>>
!CHECK:            %[[VAL_5:.*]]:2 = hlfir.declare %[[DERIVED_TYPE_ADDR]] {{.*}}
...
!CHECK:            %[[DERIVED_TYPE_ADDR:.*]] = fir.address_of(@_QFtest4Eres) {{.*}}
!CHECK:            %[[VAL_5:.*]]:2 = hlfir.declare %[[DERIVED_TYPE_ADDR]] {{.*}}
...
!CHECK:            %[[DERIVED_TYPE_ADDR:.*]] = fir.address_of(@_QFtest5Eres) {{.*}}
!CHECK:            %[[VAL_5:.*]]:2 = hlfir.declare %[[DERIVED_TYPE_ADDR]] {uniq_name = "_QFtest5Eres"} {{.*}}
